...
export class Backend implements backendInterface {
    ...
    async createSeries(arg0: string, arg1: string, arg2: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createSeries(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteSeries(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllSeriesByUser(): Promise<Array<[Principal, Array<BarcodeSeries>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSeriesByUser();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSeriesCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSeriesCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSeries(arg0: bigint): Promise<BarcodeSeries> {
        if (this.processError) {
            try {
                const result = await this.actor.getSeries(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserSettings(): Promise<string | null> {
        if (this.processError) {
            try {
    ...
    async listSeries(): Promise<Array<BarcodeSeries>> {
        if (this.processError) {
            try {
                const result = await this.actor.listSeries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async renameSeries(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.renameSeries(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveUserSettings(arg0: string): Promise<void> {
        if (this.processError) {
            try {
